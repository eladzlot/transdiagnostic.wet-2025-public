...
Because participants were recruited from the same platform using identical screening, compensation, and measurement procedures, systematic bias other than time effects is unlikely (see Sorka et al., in preparation).
...
Inter-rater agreement was substantial (Cohen's κ = 0.70, 95\% CI {[}0.40, 1.00{]}, 85.7\% agreement).
