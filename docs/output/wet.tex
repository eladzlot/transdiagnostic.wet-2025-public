...
This paper introduces transdiagnostic WET, a future oriented version of WET tailored for a population with transdiagnostic anxiety symptoms.
...
We propose that transdiagnostic WET should focus on core threats: the ultimate feared consequence of one's fear or anxiety (Huppert \& Zlotnick, 2012; Zlotnick \& Huppert, 2025b).
...
We have developed an online questionnaire to reliably identify core threats (Zlotnick \& Huppert, 2025a).
...
The CTSI is a structured and psychometrically validated online assessment designed to elicit the individual's ultimate feared outcome underlying anxiety or avoidance (Zlotnick \& Huppert, 2025a).
...
Reductions in perceived threat, indexed by state anxiety during imagining the core threat {[}BSAM; Berg et al. (1998){]}, reflect habituation or extinction processes.
Broader regulatory and cognitive mechanisms included distress tolerance {[}DTS; Simons and Gaher (2005){]}, reflecting the ability to endure negative emotion, self-compassion {[}SCS; Raes et al. (2011){]}, representing adaptive self-relating and emotional regulation; and thought--action fusion {[}TAF-R; Shafran et al. (1996){]}, the belief that thoughts can cause or prevent real outcomes.
Metacognitive beliefs {[}MCQ-30; Wells and Cartwright-Hatton (2004){]} and core schemas {[}BCSS; Fowler et al. (2006){]} indexed higher-order beliefs about control, self, and others.
...
Central to pathological fear is an inflated sense of threat, making perceived threat reduction key to alleviating anxiety (Zlotnick \& Huppert, 2025b).
...
Furthermore, improving the threat script by better reflecting the core threat and decreasing avoidance may also be important (Zlotnick \& Huppert, 2025b).
...
Zlotnick, E., \& Huppert, J. D. (2025a). \emph{The Core Threat Structured Interview: Pyschoemetrics and Phenomenology} {[}Paper submitted for publication{]}.

\leavevmode\vadjust pre{\hypertarget{ref-zlotnickMotivationalAnatomyFear2025}{}}%
Zlotnick, E., \& Huppert, J. D. (2025b). The motivational anatomy of fear: A closer look at core threats. \emph{Clinical Psychology Review}, \emph{122}, 102655. \url{https://doi.org/10.1016/j.cpr.2025.102655}
