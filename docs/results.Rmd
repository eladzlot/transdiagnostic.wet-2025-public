...
n_engaged = sum(raw.engagement$engagement.1)
...
Most `r format_count_perc(n_engaged, nrow(raw.engagement))` of the participants who completed WET were classified as having engaged with their identified core threat at least once across the four writing sessions.
...
A modest advantage was observed for engagers at the one-week follow-up (`r format_estimate(delta.fu1.yes - delta.fu1.niw)`), and by the two-month follow-up the difference was larger and statistically reliable (`r format_estimate(delta.fu2.yes - delta.fu2.niw)`).
