...
abstract: |
  ...
  To achieve this, we conducted a randomized controlled trial (RCT) comparing WET to a neutral imagery task and a waitlist control group, with all interventions fully self-administered.
  Outcomes were analyzed using Bayesian multilevel linear IRT models.
  The results demonstrated that WET was highly effective, with an effect size of *d* = 0.85 compared to waitlist, and that changes in distress tolerance (*r* = 0.37) and anxiety regarding core threats (*r* = 0.39) correlated with symptom reduction.
