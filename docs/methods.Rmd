...
Because participants were recruited from the same platform using identical screening, compensation, and measurement procedures, systematic bias other than time effects is unlikely [see @sorkaTransdiagnosticSelfGuidedImageryinpreparation].
