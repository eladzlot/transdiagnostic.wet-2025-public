...
We propose that transdiagnostic WET should focus on core threats: the ultimate feared consequence of one's fear or anxiety [@huppertCoreFearsValues2012; @zlotnickAnatomyFearCloser2025].
...
However, we also aim to explore several potential mechanisms [cf. @rousseauMechanismsActionUnderlying2018] as such knowledge may allow more precise interventions [@nivPrecisionCognitiveBehavioral2021].
